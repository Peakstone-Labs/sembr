...
- A backfill warning is a **recall** warning: filters on publication time, language, url domain or body length may miss older articles until it clears. Report the result as incomplete rather than presenting the short list as the answer.
