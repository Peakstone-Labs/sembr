...
Write a concise summary (3–5 sentences) of the key developments across the articles above.

- Respond in the same language as the user's topic above (not the articles — articles may be mixed-language).
- Do not reproduce URLs or index numbers in the output.
- If multiple articles report the same fact, state it once.
