...
|--------|---------------|
| [db](db.md) | SQLite persistence — feeds, articles, intents, dedup state |
...
| [matcher](matcher.md) | Scheduled ANN search (cron + event modes), match event emission |
| [summarizer](summarizer.md) | LLM summary generation from matched article clusters |
| [notifier](notifier.md) | Email digest delivery (marker-ABC ready for Telegram / Discord / Slack channels) |
